    ...
    $(document).ready(function () {
        ...
        $("#confirm-guardar").click(function (event) {
            ...
            $.ajax({
                ...
                if (data == "")
                {
                    window.location.href = "<?php echo base_url(); ?>index.php/definiciones/lista";
                }
                else
                {
                    $('#mensaje').html(data);
                            ...
                            <div class="col-md-12">
                                <section class="panel">
                                    <header class="panel-heading">
                                        <h2 class="panel-title">Nueva definición</h2>
                                    </header>
                                    <div class="panel-body">
                                        <div class="form-group">
                                            <label class="col-sm-3 control-label">Glosario <span class="required">*</span></label>
                                            <div class="col-sm-9">
                                                <?php
                                                llenaComboGlosario('');
                                                ?>                                               
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" name="palabra" class="form-control" placeholder="ej.: CMMI" maxlength="100" required/>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <textarea name="definicion" rows="3" maxlength="500" 
                                                          class="form-control" placeholder="Proporcione definición de la palabra" required></textarea>
                                            </div>
                                        </div>
                                    </div>
