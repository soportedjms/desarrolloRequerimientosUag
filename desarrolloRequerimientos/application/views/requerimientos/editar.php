...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        if ($("#operacion").val() == "D")
        {
            ...
            $("#idPrioridad").prop("disabled", true);
...
//////////////////////////////////////////ACTIVIDADES////////////
        ...
        $("#guardar").click(function (event) {
            ...
            $.ajax({
                ...
                type: "POST",
                data: {idproyecto: $("#idProyecto").val(), idusuario: $("#idRequerimientoUsuario").val(), idProyectoOri: $("#proyectoOriginal").val()}
            }).done(function (data) {
                msj = data;
                if (msj != '')
                {
            ...
            <div class="col-md-12">
                <section class="panel panel-transparent">
                    ...
                    <div class="panel-body">
                        <button type="submit" class="mb-xs mt-xs mr-xs btn btn-primary" name="guardar" id="guardar" <?= $modificar ?> >
                            <i class="glyphicon glyphicon-floppy-saved"></i> Guardar</button>
                        <button type="submit" class="mb-xs mt-xs mr-xs btn btn-primary" name="modificar" id="modificar" <?= $detalle ?> 
                                onClick="window.location.href = '<?php echo base_url(); ?>index.php/requerimientos/editar/<?= $requerimiento['idRequerimiento'] ?>/<?= $requerimiento['idRequerimientoUsuario'] ?>/E'">
                            <i class="glyphicon glyphicon-pencil"></i> Modificar</button>
                        <button type="submit" class="mb-xs mt-xs mr-xs btn btn-primary" name="nuevo" id="nuevo" <?= $detalle ?> 
                                onClick="window.location.href = '<?php echo base_url(); ?>index.php/requerimientos/nuevo'">
                            <i class="glyphicon glyphicon-file"></i> Nuevo</button>
                        <button type="submit" class="mb-xs mt-xs mr-xs btn btn-primary" name="limpiar" id="limpiar"  <?= $modificar ?>>
                                ...
                                <div class="panel-body">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-3">
                                            ...
                                            <input type="hidden" id="idRequerimiento" name="idRequerimiento" value="<?= $requerimiento['idRequerimiento'] ?>">
                                            <input type="text" name="idRequerimientoUsuario" class="form-control" maxlength="10"
                                                   placeholder="ej.: 01-R0001" id="idRequerimientoUsuario" disabled
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-3">
                                            <input type="hidden" id="proyectoOriginal" name="proyectoOriginal" value="<?= $requerimiento['idProyecto'] ?>">
                                            <?php
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-3">
                                            <input type="text" id="nombre" name="nombre" class="form-control" maxlength="30"
                                                   placeholder="ej.: Requerimiento alta usuarios" <?= $disabled ?>
                                        ...
                                        <input type="hidden" id="idEstatus" name="idEstatus" value="<?= $requerimiento['idEstatus'] ?>">
                                        <label class="col-sm-2 control-label" style="color: green;font-size: 15px;font-weight: bold;"><?= $requerimiento['descEstatus'] ?> </label>
                                                ...
                                                if (!empty($atributos)) {
                                                    foreach ($atributos as $u):
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><?= $u['valor'] ?></td>
                                                            <?php if ($u['activo'] == 0) { ?>
                                                                <td><input type="checkbox" id="idAtributo" name="idAtributo[]" <?= $disabled ?> value="<?= $u['idAtributo'] ?>"/>Asignar</td>
                                                            <?php } else { ?>
                                                                <td><input type="checkbox" id="idAtributo" name="idAtributo[]" <?= $disabled ?> value="<?= $u['idAtributo'] ?>" checked=checked/>Asignar</td>
                                                            <?php } ?>
                                                        </tr>
                                                        <?php
                                                    endforeach;
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <textarea type="text" name="precondicion" class="form-control" maxlength="1000"
                                                      placeholder="Proporcione precondición" id="precondicion" <?= $disabled ?>
                                                      rows="4" <?php if (!empty($requerimiento['precondicion'])) { ?> 
                                                          value="<?= $requerimiento['precondicion'] ?>" <?php } ?> ><?php if (!empty($requerimiento['precondicion'])) {
                                                    ?><?= $requerimiento['precondicion'] ?><?php }
                                                ?></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <textarea type="text" id="postcondicion" class="form-control" maxlength="1000"
                                                      placeholder="Proporcione postcondición" name="postcondicion"  <?= $disabled ?>
                                                      rows="4" <?php if (!empty($requerimiento['postcondicion'])) { ?> 
                                                          value="<?= $requerimiento['postcondicion'] ?>" <?php } ?> ><?php if (!empty($requerimiento['postcondicion'])) {
                                                    ?><?= $requerimiento['postcondicion'] ?><?php }
                                                ?></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <textarea type="text" name="descripcionCorta" class="form-control" maxlength="1000"
                                                      placeholder="Proporcione descripción corta" id="descripcionCorta" <?= $disabled ?>
                                                      rows="4" <?php if (!empty($requerimiento['descripcionCorta'])) { ?> 
                                                          value="<?= $requerimiento['descripcionCorta'] ?>" <?php } ?> ><?php if (!empty($requerimiento['descripcionCorta'])) {
                                                    ?><?= $requerimiento['descripcionCorta'] ?><?php }
                                                ?></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <textarea type="text" name="descripcionDetallada" class="form-control" maxlength="10000"
                                                      placeholder="Proporcione descripción detallada" id="descripcionDetallada" <?= $disabled ?>
                                                      rows="13" <?php if (!empty($requerimiento['descripcionDetallada'])) { ?> 
                                                          value="<?= $requerimiento['descripcionDetallada'] ?>" <?php } ?> ><?php if (!empty($requerimiento['descripcionDetallada'])) {
                                                    ?><?= $requerimiento['descripcionDetallada'] ?><?php }
                                                ?></textarea>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <section class="panel">
                                ...
                                <div class="panel-body">
                                    <div>
                                        <button type="submit" class="mb-xs mt-xs mr-xs btn btn-primary" <?= $disabled ?> name="agregarPeticion" id="agregarPeticion">
                                                ...
                                                if (!empty($peticiones)) {
                                                    foreach ($peticiones as $u):
                                                        ...
                                                        <tr id="<?= "row-" . $u['idPeticion'] ?>">
                                                            ...
                                                            <td class="actions">
                                                                <?php if ($disabled == "") { ?>
                                                                    <a class="show-delete-modal-peticion" <?= $disabled ?> href="#" data-idpeticion="<?= $u['idPeticion'] ?>" data-toggle="modal" data-target="#modal-eliminar-peticion">
                        ...
                        <div class="col-md-6">
                            <section class="panel">
                                ...
                                <div class="panel-body">
                                    <div>
                                        <button type="submit" class="mb-xs mt-xs mr-xs btn btn-primary"  <?= $disabled ?> name="agregarArtefacto" id="agregarArtefacto">
                                            <i class="glyphicon glyphicon-file"></i>Agregar</button>
                                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <section class="panel">
                                ...
                                <div class="panel-body">
                                    <div>
                                        <button type="submit" class="mb-xs mt-xs mr-xs btn btn-primary"  <?= $disabled ?> name="agregarActividad" id="agregarActividad">
                                            <i class="glyphicon glyphicon-file"></i>Agregar</button>
                                    </div>
                                    <div class="table-responsive">
                                                ...
                                                if (!empty($actividades)) {
                                                    foreach ($actividades as $u):
                                                        ...
                                                        <tr id="<?= "row-" . $u['idActividad'] ?>">
                                                            ...
                                                            <td><?= $u['descripcion'] ?></td>
                                                            <td><?= $u['duracionHrs'] ?></td>
                                                            <td><input type="text" <?= $disabled ?> id="hrsReales" onkeypress="return event.charCode >= 48 && event.charCode <= 57" name="hrsReales" class="form-control" maxlength="5" value="<?= $u['hrsReales'] ?>"/></td>
                                                            <td><input type="text" <?= $disabled ?> name="responsable" class="form-control" maxlength="100" value="<?= $u['responsable'] ?>"/></td>
                                                            <td> 
                                                                <?php
                                                                if ($disabled != "") { ?>
                                                                    <?= $u['descEstatus'] ?>
                                                                ...
                                                                if (!empty($u['idEstatus'])) {
                                                                    llenaComboEstatus($u['idEstatus'], 'A');
                                                                } else {
                                                                    llenaComboEstatus("1", 'A');
                                                                } }
                                                                ?>     
                                                            </td>
                                                            <td class="actions">
