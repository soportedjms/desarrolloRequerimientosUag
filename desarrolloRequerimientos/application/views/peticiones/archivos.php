...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $("#confirm-delete").click(function (event) {
            ...
            $.ajax({
                url: "<?php echo base_url(); ?>index.php/peticiones/eliminarArchivo",
                type: "POST",
        ...
        <div class="col-md-9 col-lg-12 col-xl-9">
            <section class="panel">
                <div class="panel-body">
                    <form id="formInicial" action="<?php echo base_url(); ?>index.php/peticiones/nuevoArchivo" method="POST" enctype="multipart/form-data" >
                        <div class="row">
                            <div class="col-md-12">
                                <section class="panel">
                                    <header class="panel-heading">
                                        <h2 class="panel-title">Agregar archivos de evidencia</h2>
                                    </header>
                                    <div class="panel-body">
                                        <div>
