        ...
        <div class="col-md-9 col-lg-12 col-xl-9">
            <section class="panel">
                <div class="panel-body">
                    <form id="formInicial" method="post" action="<?php echo base_url(); ?>index.php/peticiones/guardarEditar" >
                        <div class="row">
                            <div class="col-md-9">
                                <section class="panel">
                                    <header class="panel-heading">
                                        <h2 class="panel-title">Editar petición</h2>
                                    </header>
                                    <div class="panel-body">
                                         <div class="form-group">                                          
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" name="nombre" maxlength="50" class="form-control" 
                                                       placeholder="ej.: Solicitud 2013" value="<?= $peticion['nombre'] ?>" required/>
                                            </div>
                                        </div>
                                        
                                        <div class="form-group">
                                            <input type="hidden" name="idPeticion" value="<?= $peticion['idPeticion'] ?>" />
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" name="descripcion" class="form-control" maxlength="100"
                                                       placeholder="Proporcione descripción" value="<?= $peticion['descripcion'] ?>" required/>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <textarea name="descripcionDetallada" id="descripcionDetallada" class="form-control"  maxlength="3000"
                                                          placeholder="Proporcione descripción detallada" 
                                                          value="<?= $peticion['descripcionDetallada'] ?>"><?= $peticion['descripcionDetallada'] ?></textarea>
                                            </div>
                                        </div>
                                         ...
                                         <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <?php
                                                if (!empty($peticion['idProyecto'])) {
                                                    llenaComboProyectos($peticion['idProyecto']);
                                                } else {
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <?php
                                                if (!empty($peticion['idEstatus'])) {
                                                    llenaComboEstatus($peticion['idEstatus'],'T');
                                                } else {
