...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $(".show-delete-modal").click(function (event) {
            tipo_borrar = $(this).data("idtipo");
        });

        $("#confirm-delete").click(function (event) {
            event.preventDefault();
            $.ajax({
                url: "<?php echo base_url(); ?>index.php/tiposRequerimiento/eliminarTipoRequerimiento",
                type: "POST",
                data: {idtipo: tipo_borrar}
            }).done(function (data) {
                if (data=="no")
                {
        ...
        <div class="col-md-9 col-lg-12 col-xl-9">
            <section class="panel">
                <div class="panel-body">
                    <form id="formInicial" method="post" action="<?php echo base_url(); ?>index.php/tiposRequerimiento/nuevo" >
                        <div class="row">
                            <div class="col-md-12">
                                <section class="panel">
                                    <header class="panel-heading">
                                        <h2 class="panel-title">Tipos de requerimiento</h2>
                                    </header>
                                    <div class="panel-body">
                                        <div>
                                                ...
                                                <tbody>
                                                    ...
                                                    foreach ($tipos as $u): ?>
                                                        <tr>
                                                            ...
                                                            <td><?= $u['furps'] ?></td>
                                                            <td class="actions">
                                                                <a href="<?php echo base_url(); ?>index.php/tiposRequerimiento/editar/<?= $u['idTipo'] ?>"><i class="fa fa-pencil"></i></a>
                                                                <a class="show-delete-modal" href="#" data-idtipo="<?= $u['idTipo'] ?>" data-toggle="modal" data-target="#modal-eliminar">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>¿Desea eliminar el tipo de requerimiento?</p>
                </div>
