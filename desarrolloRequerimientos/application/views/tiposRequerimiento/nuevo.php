        ...
        <div class="col-md-9 col-lg-12 col-xl-9">
            <section class="panel">
                <div class="panel-body">
                    <form id="formInicial" method="post" action="<?php echo base_url(); ?>index.php/tiposRequerimiento/guardarNuevo" >
                        <div class="row">
                            <div class="col-md-12">
                                <section class="panel">
                                    <header class="panel-heading">
                                        <h2 class="panel-title">Nuevo tipo de requerimiento</h2>
                                    </header>
                                    <div class="panel-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-9">
                                                    <div class="radio-custom radio-primary">
                                                        <input id="si" name="furps" type="radio" value="1"  required/>
                                                        <label for="si">Si</label>
                                                    </div>
                                                    <div class="radio-custom radio-primary">
                                                        <input id="no" name="furps" type="radio" value="0"  />
