        ...
        <div class="col-md-9 col-lg-12 col-xl-9">
            <section class="panel">
                <div class="panel-body">
                    <form id="formInicial" method="post" action="<?php echo base_url(); ?>index.php/modulos/guardarNuevo" >
                        <div class="row">
                            <div class="col-md-12">
                                <section class="panel">
                                    <header class="panel-heading">
                                        <h2 class="panel-title">Nuevo módulo</h2>
                                    </header>

                                    <div class="panel-body">
                                        <label class="col-sm-3 control-label">Descripción <span class="required">*</span></label>
                                        <div class="col-sm-9">
                                            <input type="text" name="descripcion" class="form-control" placeholder="ej.: Catálogos" required/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="nombreIcono" class="form-control" placeholder="ej.: fa fa-edit" required/>
                                        </div>
                                    </div>
