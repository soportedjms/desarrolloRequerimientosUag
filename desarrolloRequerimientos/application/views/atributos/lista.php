...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        var atributo_borrar = 0;

        $(".show-delete-modal").click(function (event) {
            atributo_borrar = $(this).data("idatributo");
        });

        $("#confirm-delete").click(function (event) {
            event.preventDefault();
            $.ajax({
                url: "<?php echo base_url(); ?>index.php/atributos/eliminarAtributo",
                type: "POST",
                data: {idatributo: atributo_borrar}
            }).done(function (data) {
                if (data == "no")
                {
        ...
        <div class="col-md-6 col-lg-12 col-xl-6">
            <section class="panel">
                <div class="panel-body">
                    <form id="formInicial" method="post" action="<?php echo base_url(); ?>index.php/atributos/nuevo" >
                        <div class="row">
                            <div class="col-md-12">
                                <section class="panel">
                                    ...
                                    <div class="panel-body">
                                        <div>
                                            ...
                                            <button type="submit" class="mb-xs mt-xs mr-xs btn btn-primary" name="nuevo" value="nuevo">
                                                <i class="glyphicon glyphicon-file"></i>Nuevo atributo</button>
                                        </div>
                                                    ...
                                                    if (!empty($atributos)) {
                                                        foreach ($atributos as $u):
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><?= $u['valor'] ?></td>
                                                                <td class="actions">
                                                                    <a href="<?php echo base_url(); ?>index.php/atributos/editar/<?= $u['idAtributo'] ?>"><i class="fa fa-pencil"></i></a>
                                                                    <a class="show-delete-modal" href="#" data-idatributo="<?= $u['idAtributo'] ?>" data-toggle="modal" data-target="#modal-eliminar">
