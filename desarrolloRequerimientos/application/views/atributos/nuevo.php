        ...
        <div class="col-md-9 col-lg-12 col-xl-9">
            <section class="panel">
                <div class="panel-body">
                    <form id="formInicial" method="post" action="<?php echo base_url(); ?>index.php/atributos/guardarNuevo" >
                        <div class="row">
                            <div class="col-md-12">
                                <section class="panel">
                                    ...
                                    <div class="panel-body">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" name="descripcion" maxlength="200"  class="form-control" placeholder="ej.: Proporcione descripción" required/>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" name="valor" maxlength="30"  class="form-control" required/>
                                            </div>
                                        </div>
                                    </div>
